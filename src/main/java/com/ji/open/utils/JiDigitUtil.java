...
//        data=authStringPrefix+bodyData
    ...
    public static String signEcdsa(String data, String privateKeyBase64) {
//        data=authStringPrefix+bodyData
        return sign(data, privateKeyBase64, ECC_ALGORITHM, ECDSA_SHA_ALGORITHM);
    }
...
//        data=authStringPrefix+bodyData
    ...
    public static boolean verifyEcdsa(String bodyDataStr, String signature, String publicKeyBase64) {
//        data=authStringPrefix+bodyData
        return verify(bodyDataStr, signature, publicKeyBase64, ECC_ALGORITHM, ECDSA_SHA_ALGORITHM);
    }
    ...
    public static String[] genKeyPair(String algorithm) {
        ...
        try {
            ...
            if (ECC_ALGORITHM.equals(algorithm)){
//                未来10年都没有变，那么椭圆曲线使用521
